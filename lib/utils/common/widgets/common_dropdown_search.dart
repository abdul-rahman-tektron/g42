...
import 'package:smartcards/utils/common_validation.dart';
...
class _CustomSearchDropdownState<T> extends State<CustomSearchDropdown<T>> with WidgetsBindingObserver {
        ...
        children: [
          ...
          TextFormField(
            ...
            validator: widget.skipValidation
                ? null
                : widget.validator ??
                    CommonValidation().commonValidator,
  ...
  OutlineInputBorder _defaultBorder() {
    return OutlineInputBorder(
      borderSide:
      const BorderSide(color: AppColors.inputFocusedBorderColor, width: 2.5),
      borderRadius: BorderRadius.circular(15),
    );
  }
}
