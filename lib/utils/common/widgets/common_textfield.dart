      ...
      builder: (context, child) => Theme(
        data: Theme.of(context).copyWith(
          datePickerTheme: DatePickerThemeData(
            ...
            headerForegroundColor: AppColors.surfaceColor,
          ),
          ...
          builder: (context, child) => Theme(
            data: Theme.of(context).copyWith(
              timePickerTheme: TimePickerThemeData(
                ...
                hourMinuteTextColor: AppColors.surfaceColor,
              ...
              Row(
                children: [
                  ...
                  if (!widget.skipValidation)
                    ...
                    const Text("*", style: TextStyle(fontSize: 15, color: AppColors.errorColor)),
        ...
        CompositedTransformTarget(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              fillColor: widget.isEnable ? (widget.backgroundColor ?? AppColors.surfaceColor) : AppColors.inputBorderColor,
              filled: true,
              ...
              border: _buildBorder(widget.borderColor ?? AppColors.inputFocusedBorderColor),
              enabledBorder: _buildBorder(widget.borderColor ?? AppColors.inputFocusedBorderColor),
              disabledBorder: _buildBorder(widget.borderColor ?? AppColors.inputFocusedBorderColor),
              errorBorder: _buildBorder(widget.borderColor ?? AppColors.inputFocusedBorderColor),
              focusedBorder: _buildBorder(widget.borderColor ?? AppColors.inputFocusedBorderColor),
              focusedErrorBorder: _buildBorder(widget.borderColor ?? AppColors.inputFocusedBorderColor),
            ),
          ),
        ),
      ],
