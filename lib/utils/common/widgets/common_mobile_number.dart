    ...
    return Column(
      ...
      children: [
        ...
        FormField<String>(
          ...
          validator: skipValidation ? null : CommonValidation().validatePassword,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isEnable ? AppColors.surfaceColor : AppColors.inputBorderColor,
                        borderRadius: BorderRadius.circular(15.0),
                        border: Border.all(color: AppColors.inputFocusedBorderColor, width: 2.5),
                      ),
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: isEnable ? AppColors.surfaceColor : AppColors.inputBorderColor,
                          hintStyle: AppFonts.textRegularGrey16,
                          contentPadding: const EdgeInsets.symmetric(vertical: 15, horizontal: 12),
                          errorStyle: const TextStyle(height: 0),
                          // hide default error space
                          border: _buildBorder(AppColors.inputFocusedBorderColor),
                          enabledBorder: _buildBorder(AppColors.inputFocusedBorderColor),
                          focusedBorder: _buildBorder(AppColors.inputFocusedBorderColor),
                          disabledBorder: _buildBorder(AppColors.inputFocusedBorderColor),
                        ),
                      ),
                    ),
                  ],
